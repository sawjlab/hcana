...
class TClonesArray;
class THcTrackExtraingDetector;
...
public:
  ...
  THcTrackExtra( Double_t x, Double_t y, Double_t theta, Double_t phi,
	    THcTrackExtraingDetector* creator=0, THcTrackExtraID* id=0,
	    THaPIDinfo* pid=0 )
    : TObject(),
  ...
  THcTrackExtraID*       GetID()            const { return fID; }
  ...
  void              SetID( THcTrackExtraID* id )   { fID   = id; }
...
protected:
  ...
  THcTrackExtraID*       fID;     //! Track identifier
  ...
  ClassDef(THcTrackExtra,4)       // A generic particle track
};

//__________________ inlines __________________________________________________
inline
void THcTrackExtra::SetD( Double_t x, Double_t y, Double_t theta, Double_t phi )
{
...
inline
void THcTrackExtra::SetR( Double_t x, Double_t y, Double_t theta, Double_t phi )
{
  // set the coordinates in the rotated focal-plane frame
  fRX = x;
  fRY = y;
...
//_____________________________________________________________________________
inline
void THcTrackExtra::SetTarget( Double_t x, Double_t y, Double_t theta, Double_t phi )
{
